...
from functions.layer_events import layer_conversion
...
print(end-start)
#layer_stats.to_csv("error_rate_data/Layer_Stats_Env.csv", sep=',')

# Drop rows who have a layer thickness of 0
...
# csv_file_path = "final_data/Layer_Stats_Env_Tagged.csv"
# df = pd.read_csv(csv_file_path)
# print(df.shape)
df_tagged = tag(df)
